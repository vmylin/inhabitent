...
{
	remove_submenu_page('themes.php', 'theme-editor.php'); //remove submenu editor not the theme tab
	remove_submenu_page('plugins.php', 'plugin-editor.php'); //remove submenu editor not the plugins tab
}
...
function red_starter_scripts()
{
	...
	wp_enqueue_script('inhabitent-search-animation', get_template_directory_uri() . '/build/js/style.min.js', array(), '20151215', true);
